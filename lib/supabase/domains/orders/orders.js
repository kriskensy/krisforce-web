...
export async function getOrders(filters) {
  try {
    ...
    let query = supabase
      .from('orders')
      .select('id, order_number, order_date, total_amount, status_id, order_statuses (name), client_id, clients (name), orders_client_id_fkey (name), created_by, created_at, deleted_at', { count: 'exact' })
