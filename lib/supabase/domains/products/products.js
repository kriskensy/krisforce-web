...
export async function getProducts(filters = {}) {
  try {
    ...
    let query = supabase
      .from('products')
      .select('id, code, name, category_id, product_categories (*), standard_price, deleted_at', { count: 'exact' })
...
export async function getProductById(id) {
  try {
    ...
    const { data, error } = await supabase
      .from('products')
      .select('id, code, name, category_id, product_categories (*), standard_price, deleted_at')
      .eq('id', id)
      .maybeSingle()
