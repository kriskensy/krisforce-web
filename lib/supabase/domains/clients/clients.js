...
export async function getClients(filters = {}) {
  try {
    ...
    let query = supabase
      .from('clients')
      .select('id, name, nip, created_by, created_at, client_addresses (id, street, city, zip_code, address_types (code, name)), client_contacts (id, contact_type_id, value, contact_types (code, name)), deleted_at', { count: 'exact' })
...
export async function getClientById(id) {
  try{
    ...
    const { data, error } = await supabase
      .from('clients')
      .select('id, name, nip, created_by, created_at, client_addresses (id, street, city, zip_code, address_types (code, name)), client_contacts (id, contact_type_id, value, contact_types (code, name)), deleted_at')
      .eq('id', id)
      .maybeSingle()
