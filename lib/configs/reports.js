...
export const REPORT_CONFIGS = {
  client_summary: {
    ...
    columns: [
      ...
      { id: 'total_invoiced', label: 'Total Invoiced', default: true, format: (v) => `${Number(v).toLocaleString()} €` },
      { id: 'total_paid_to_date', label: 'Total Paid', default: true, format: (v) => `${Number(v).toLocaleString()} €` },
