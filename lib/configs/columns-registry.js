import { getColumns as getClientsColumns } from "@/app/protected/(features)/clients/list/columns";
...
import { getColumns as getOrdersColumns } from "@/app/protected/(features)/sales/orders/list/columns";
...
import { getColumns as getInvoicesColumns } from "@/app/protected/(features)/sales/invoices/list/columns";
...
import { getColumns as getPaymentsColumns } from "@/app/protected/(features)/sales/payments/list/columns";
import { getColumns as getPaymentMethodsColumns } from "@/app/protected/(features)/sales/payments/payment_methods/columns";

import { getColumns as getTicketsColumns } from "@/app/protected/(features)/tickets/list/columns";
...
import { getColumns as getUsersColumns } from "@/app/protected/(features)/users/list/columns";
import { getColumns as getUserProfilesColumns } from "@/app/protected/(features)/users/user_profiles/columns";
...
export const GLOBAL_COLUMNS_REGISTRY = {
  ...
  'user_profiles': getUserProfilesColumns,
