...
export const SALES_SUB_FEATURES = {
  'invoices': {
    ...
    fields: [
      ...
      { name: 'total_amount', label: 'Total Amount', type: 'number', isCurrency: true, required: true },
      { name: 'paid_amount', label: 'Paid Amount', type: 'number', isCurrency: true, required: false },
  ...
  'invoice_items': {
    ...
    fields: [
      ...
      { name: 'total_price', label: 'Total Price', type: 'number', isCurrency: true, required: true },
  ...
  'order_items': {
    ...
    fields: [
      ...
      { name: 'quantity', label: 'Quantity', type: 'number', required: true },
      { name: 'unit_price', label: 'Unit Price', type: 'number', isCurrency: true, required: true },
      { name: 'total_price', label: 'Total Price', type: 'number', isCurrency: true, required: false }
    ]
  },
  'order_workflow': {
