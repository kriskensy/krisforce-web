...
//TODO check DB columns, fix issues with commented code
export const SALES_SUB_FEATURES = {
  ...
  'order_workflow': {
    ...
    fields: [
      ...
      // { //TODO dont display on modal, supabase procedure??
      //   name: 'old_status_id', 
      //   label: 'Old Status', 
      //   type: 'select', 
      //   required: true, 
  ...
  'invoices': {
    ...
    fields: [
      // { name: 'invoice_number', label: 'Invoice Number', type: 'text', required: true },//TODO generate in supabase?
      { 
        name: 'client_id', 
        label: 'Client', 
        type: 'select', 
      ...
      // { name: 'total_amount', label: 'Total Amount', type: 'number', required: true },//TODO generate in supabase?
